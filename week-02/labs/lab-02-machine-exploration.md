...
**OS and version:** Device name	DESKTOP-JP17I5S Processor	11th Gen Intel(R) Core(TM) i7-1185G7 @ 3.00GHz (3.00 GHz) Installed RAM	16.0 GB (15.7 GB usable) Graphics card	Intel(R) Iris(R) Xe Graphics (128 MB) Storage	92 GB of 238 GB used Device ID	706A281D-D946-40E5-9E13-7DC300ADC125 Product ID	00330-80000-00000-AA447 System type	64-bit operating system, x64-based processor Pen and touch	Pen and touch support with 10 touch points
...
**Cheat sheet — common processes you'll likely see (not exhaustive, just a starting reference):** CPU, Memory, Disk, Wi-Fi, and GPU
...
![Task Manager / Activity Monitor screenshot](https://assets/screenshots/week-02/machine-exploration.png)
...
```
Part A gave me specific details about my computer, and Part B helped me see how those parts work together while the computer is running. The amount of RAM and storage represents the hardware layer. The OS version represents the operating system layer that controls and communicates with the hardware.
```
...
```
Microsoft Word is an example of software because it performs tasks for the user. It relies on the operating system to control how it uses the computer’s resources. Without working hardware like the processor, RAM, and storage drive, Word would not be able to open, process, or save documents.
```
...
```
CPU activity can provide clues about what is happening behind the scenes on a computer. If an unfamiliar process starts using a high amount of CPU when I am not doing anything, it may require further investigation. Paying attention to these changes can help detect possible security threats.
```
...
```
Both the diagram and Task Manager showed that software, the OS, and hardware work together. The diagram gave me a simple picture of how the layers are connected, while Task Manager showed actual processes using system resources. Seeing the numbers change helped me understand how active and dynamic the computer really is.
```
